...
posted to #silicon-dev on irc.freenode.net).
...
The "Silicon Maintainer Team" is defined in this document as the following users:
- fluffypony
- siliconmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to Silicon code or Silicon's dependency code or Silicon's potential/future dependency code or research which successfully implements Silicon.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Silicon Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Silicon Maintainer Team.
